...
# declare a variable rng which is an instance of default_rng()
rng = default_rng()
# create an array of values in a standard normal deviation
data = rng.standard_normal(NUM_DATA_POINTS)

# create series w/ index from above
s1 = pd.Series(data, index=index)
# create series w/ auto-generated index (0, 1, 2, 3, ...)
s2 = pd.Series(data)
